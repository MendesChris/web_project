    ...
    <main role="main">
                ...
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      ...
                      <p class="text-white text-size-16 margin-bottom-40">Frutas frescas em casa nunca foi tão fácil!<br><br> Confira nossos produtos!</p>  
                    </div>                  
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="s-12 center">
                ...
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-black text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Cadastre-se já!</p>
                      <p class="text-black text-size-16 margin-bottom-30">Agilize seu acesso na hora de finalizar seu pedido, entre já na área de cadastro e faça seu registro!</p>    
                    </div>                  
                  </div>
                </div>
              </div>
        ...
        <div class="line">
          <div class="margin">
            <div class="s-12 m-12 l-4 margin-m-bottom">
              ...
              <p>Confira nosso setor de produtos completo e separe já sua encomenda!</p> 
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom">
              ...
              <p>Crie já seu cadastro! Não perca tempo e registre-se já para agilizar sua navegação!</p> 
              <a class="text-more-info text-primary-hover" href="login.php">Cadastrar</a>                
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <img class="margin-bottom" src="img/img-03.jpg" alt="">
              <h2 class="text-thin">Sobre Nós</h2>
              <p>Conheça mais sobre nossa companhia!</p> 
      ...
      <section class="section background-primary text-center">
        <div class="line">
          <div class="s-12 m-10 l-8 center">
            <h2 class="headline text-thin text-s-size-30">A Jô Fits é uma empresa tecnológica e ecológica</h2>
            <p class="text-size-20">Todos os produtos do catálogo são naturais e orgânicos (livre de agrotóxico).</p>
          </div>
        </div>  
      </section>
      ...
      <section class="section background-white">
        <div class="full-width text-center">
          ...
          <div class="line">
            <h2 class="headline text-thin text-s-size-30">Somos <span class="text-primary">Qualidade e Praticidade</span> Para Você</h2>
            <p class="text-size-20 text-s-size-16 text-thin">A Jô Fitz tem o objetivo de mudar a forma do consumidor em adquirir
alimentos e conscientizar o público para uma alimentação saudável. Com práticas
de sustentabilidade, seremos uma empresa de referência em alimentação saudável,
com a missão em ser líder no mercado de vendas alimentícios. Entregar ao cliente
uma nova experiência de compras, com um mix de produtos naturais, visando a
atender as necessidades dos clientes e procurando a excelência no atendimento e
        ...
        <div class="line">
          <div class="margin">
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom-2x">
              ...
              <p class="text-size-20"><em>Queremos oferecer um serviço de qualidade, e disponibilizar aos clientes uma
forma simples e rápida de obter produtos frescos, saudáveis e naturais. Contribuindo
diretamente e indiretamente com enfrentamento da pandemia.</em><p>
              ...
              <div class="line">
                ...
                <div class="margin">
                  ...
                  <div class="s-12 m-12 l-8 margin-m-bottom">
                    <p>A ideia que nos impulsionou para a Jô Fits surgiu a partir de uma carência identificada no comércio alimentício...</p>
                    <a class="text-more-info text-primary-hover" href="about.html">Leia mais</a>
                  </div>
                </div>
              </div>
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom-2x">
              ...
              <div class="line">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                  <p><b>Endereço:</b> Rua da Feira 7, São Paulo</p>
                </div>
              </div>
              <div class="line">
                <div class="s-1 m-1 l-1 text-center">
